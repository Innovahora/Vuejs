<template>
  <div>
    <div class="row">
      <div class="col-md-12">
        <form class="form" @submit.prevent="getMixedCommission">
    ...
    <div class="row" v-show="event_change.loading_get">
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-6">
            <GraphicMixedCommission :options="options_type.year"></GraphicMixedCommission>
          </div>
          <div class="col-md-6">
            <GraphicMixedCommission :options="options_type.month"></GraphicMixedCommission>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="tab tab-style-a">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab-year" role="tabpanel">
                  <div class="row">
                    <div class="col-md-12 text-right">
                      <ButtonExportToExcelMixedCommission :options="options_button_export.year"></ButtonExportToExcelMixedCommission>
                      <br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="table-responsive">
                        <TableMixedCommission :options="options_table.year"></TableMixedCommission>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="tab-month" role="tabpanel">
                  <div class="row">
                    <div class="col-md-12 text-right">
                      <ButtonExportToExcelMixedCommission :options="options_button_export.month"></ButtonExportToExcelMixedCommission>
                      <br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="table-responsive">
                        <TableMixedCommission :options="options_table.month"></TableMixedCommission>
                      </div>
                    </div>
                  </div>
                </div>
...
import ButtonExportToExcelMixedCommission from '@/components/commissionsBonuses/mixedCommission/buttonExportToExcelMixedCommission';
import TableMixedCommission from '@/components/commissionsBonuses/mixedCommission/tableMixedCommission';
import GraphicMixedCommission from '@/components/commissionsBonuses/mixedCommission/graphicMixedCommission';
import Toastr from 'toastr';
export default {
  name: 'mixedCommission',
  components: {
    SearchContentHeader,
    ButtonExportToExcelMixedCommission,
    TableMixedCommission,
    GraphicMixedCommission
  },
  data () {
    let date = new Date();
  ...
  methods: {
    ...
    getMixedCommission() {
      ...
      this.$store.dispatch('getDataMixedCommission', payload);
    },
    setExportToExcel() {
